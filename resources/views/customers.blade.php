            ...
            <table class="display" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="width: 100%; height: 100%; padding-top: 5px; padding-bottom: 5px; padding-left: 19px; padding-right: 20px; background: rgba(48.62, 165.75, 19.34, 0.18); border-radius: 3px; justify-content: center; align-items: center; display: inline-flex">
                                <div style="color: #31A613; font-size: 14px; font-weight: 500; word-wrap: break-word">New</div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div style="width: 100%; height: 100%; padding-top: 6px; padding-bottom: 7px; padding-left: 14px; padding-right: 12px;    background: rgba(245, 34, 45, 0.19); border-radius: 3px; justify-content: center; align-items: center; display: inline-flex">
                                <div style="text-align: center; color: #F5222D; font-size: 14px; font-weight: 500; word-wrap: break-word">Pending</div>
                            </div>
                        </td>
                        @else
                        <td>
                        ...
                        @endif
                        <td>
                            <button class="btn p-0" data-target="#editcustomer{{$customer->customer_id }}" data-toggle="modal" style="background: none;">
                        ...
                        <div class="modal fade" id="editcustomer{{$customer->customer_id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 15px;">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="">Edit Customer</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="closeModal{{$customer->customer_id }}">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ url('customer/update/'.$customer->customer_id ) }}" method="POST" id="" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="row">
                                                        <div class="col-6 mb-3">
                                                            <x-input :name="'name'" :value="$customer->customer_name" :label="'Name'" :inputType="'text'" :id="''"></x-input>
                                                        </div>
                                                        <div class="col-6 mb-3">
                                                            <x-input :name="'email'" :value="$customer->customer_email" :label="'Email'" :inputType="'email'" :id="''"></x-input>
                                                        </div>
                                                        <div class="col-12 mb-3">
                                                            <x-input :name="'phone'" :value="$customer->customer_phone" :label="'Phone Number'" :inputType="'tel'" :id="''"></x-input>
                                                        </div>
                                                        <div class="col-12 mb-3">
                                                            <x-text-area :name="'address'" :value="$customer->customer_address" :label="'Address'"></x-text-area>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div id="dropzone" class="dropzone">
                                                        <img id="profileImage{{$customer->customer_id }}" src="{{ $customer->customer_image ? asset('storage/customer_images/' . $customer->customer_image) : 'assets/images/rectangle-image.svg' }}" style="width: 100%; height: 237px; object-fit: fill;" alt="text">
                                                        <div class="file-input-container">
                                                            <input value="" class="file-input" type="file" name="upload_image" id="fileInput{{$customer->customer_id }}">
                                                            <div class="upload-icon" onclick="document.getElementById('fileInput{{$customer->customer_id }}').click()">
                                                                <img src="{{ asset('assets/images/upload-image.svg') }}" alt="Image">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <p class="error-image text-danger d-none" style="font-size: smaller;"></P>
                                                    {{-- <img src="{{asset('storage/customer_images/' . $customer->user_image)}}" alt="image">
                                                    @endif --}}
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-8 mb-3">
                                                    ...
                                                    @endphp
                                                    <x-social-input :socialLogo="'assets/images/fb-logo.svg'" :value="$fbAcc" :name="'fb_acc'" :qrId="''" :qrName="''"></x-social-input>
                                                    <x-social-input :socialLogo="'assets/images/ig-logo.svg'" :value="$igAcc" :name="'ig_acc'" :qrId="''" :qrName="''"></x-social-input>
                                                    <x-social-input :socialLogo="'assets/images/tt-logo.svg'" :value="$ttAcc" :name="'tt_acc'" :qrId="''" :qrName="''"></x-social-input>
                                                </div>
                    ...
                    <script>
                        ...
                        } = document.getElementById('fileInput{{$customer->customer_id}}');
                        const profileImage {
                            {
                                $customer - > customer_id
                            }
                        } = document.getElementById('profileImage{{$customer->customer_id}}');
                        const form {
                            {
                                $customer - > customer_id
                            }
                        } = document.getElementById('myForm{{$customer->customer_id}}');
