    ...
    <div class="table-responsive">
        <table class="table " id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                    <img class="img-size" src="{{asset('storage/service_images/'.$item->service_image)}}" alt="image">
                    </td>
                    ...
                    <td>
                        <button class="btn p-0" style="background: none;" data-target="#editservice{{$item->company_id}}" data-toggle="modal">
                ...
                <!-- Modal -->
                <div class="modal fade" id="editservice{{$item->company_id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content" style="border-radius: 15px;">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('service/update/'.$item->service_id) }}" method="POST" id="" enctype="multipart/form-data">
                                    @csrf
                ...
                <script>
                        ...
                        const fileInput{{$item->service_id}} = document.getElementById('fileInput{{$item->serivce_id}}');
