        ...
        <div class="row">
                            ...
                            <div class="input-group col-lg-12 mb-2">
                                <div class="input-group-prepend">
                                    <span
                                        class="input-group-text bg-white px-4 border-md border-right-0 border-left-0 border-top-0 border-dark"
                                        style="border-radius: 0px !important;">
                                        <svg width="13" height="17" viewBox="0 0 13 17" fill="none" xmlns="http://www.w3.org/2000/sv">
                                            <path
            ...
            <div class="col-md-5 col-lg-5 pr-lg-5 d-lg-block d-md-block d-none mb-5 mb-md-0">
                <div class="p-2 d-flex align-items-center justify-content-center"
                    ...
                    <img src="{{ asset('assets/images/login-img.svg') }}" style="width: 100%; height: 100%;" alt="Image">
                </div>
            </div>
            <!-- Registeration Form -->
        </div>
