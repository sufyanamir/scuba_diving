    ...
    <div class="table-responsive">
        <table class="table " id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <img class="img-size" src="{{asset('storage/staff_images/'.$item->user_image)}}" alt="image">
                    </td>
                    <td>{{$item->name}}</td>
                    <td>{{$item->email}}</td>
                    <td>{{$item->phone}}</td>
                    ...
                    <td>{{$item->category}}</td>
                    <td>
                        <x-add-button class="btn p-0" style="background: none;" :value="'Edit'" :dataTarget="'#editstaff'.$item->id"></x-add-button>
                ...
                <x-modal :modalId="'editstaff'.$item->id" :formAction="''" :editData="$item"></x-modal>
                @endforeach
            </tbody>
        </table>
    </div>
