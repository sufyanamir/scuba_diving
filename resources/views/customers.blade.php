            ...
            <table class="display" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="modal fade" id="editcustomer{{$customer->customer_id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content" style="border-radius: 15px;">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ url('customer/update/'.$customer->customer_id ) }}" method="POST" id=""
